function [ZFinal,es,numDualUpdates,convDist,constr,ZOverTime] = Async_PD(cost,A,b,stepSizes,maxIterations,tolerance,lb,ub,lbDual,ubDual,alpha,delta,scBlock,primalNum,dualNum,commRate,compute_rate,plotVals,xStar)
...
%        end
        ...
        [Zs,Zp,val_primalUpdate]= infrequent__primal_computation_MILP(Zp,Zs,primalNum,zBlocks,cost,LamS,A,alpha,gamma,ub,lb,scBlock,compute_rate);
